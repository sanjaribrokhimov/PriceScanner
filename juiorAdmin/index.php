            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="card">
                        <div class="stat-widget-eight">
                            <div class="stat-header">
                                <div class="header-title pull-left" id="header-title">NO CATEGORY</div>
                                <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        const category = localStorage.getItem("category");

                                        if (category) {
                                            document.getElementById('header-title').textContent = category;
                                        } else {
                                            document.getElementById('header-title').textContent = "Default Category";
                                        }
                                    });
                                </script>
                            </div>
...
<div id="main-content">
    ...
    <script>
        ...
        const apiEndpoint = '/api/admin/dashboard';
