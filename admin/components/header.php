...
<div id="menuh" class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
            <div class="nano">
                <div class="nano-content">
                    <ul>
                        ...
                        <li><a href="addCompany.php"><i class="ti-plus"></i> Add Company </a></li>
                        <li><a href="addAdmin.php"><i class="ti-plus"></i> Add Admin</a></li>
        ...
        <div class="header">
            <div class="pull-left">
                <div class="logo"><a
                        href="index.php"><!-- <img src="assets/images/logo.png" alt="" /> --><span>check24Admin</span></a>
                </div>
